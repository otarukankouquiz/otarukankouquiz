document.addEventListener('DOMContentLoaded', function() {
    ...
    const quizData = [
        {
            question: "問1：美しい景色を発見！写真を撮りたいとき、最も適切な行動はどれですか？",
            options: [
                "他人の家の敷地に少しだけ入り、良いアングルで撮影する",
                "他人の家の敷地には絶対に入らず、公道から静かに撮影する",
                "庭の木の枝を少しよけて、綺麗な景色を撮影する"
            ],
            answer: "他人の家の敷地には絶対に入らず、公道から静かに撮影する"
        },
        {
            ...
            options: [
                ...
                "線路内への立ち入りは危険で禁止されているため、線路内で写真撮影は行わない"
            ],
            answer: "線路内への立ち入りは危険で禁止されているため、線路内で写真撮影は行わない"
        },
        {
        ...
        {
            question: "問5：観光中に買った食べ物。これをすぐに食べたいとき、どうするのが正しいですか？",
            options: [
                "お土産屋さんの商品を見ながら店内で食べる",
                "レストランに入り注文した商品と一緒に食べる",
                "買ったお店か歩道上で食べ、お店の中には持ち込まない"
            ],
            answer: "買ったお店か歩道上で食べ、お店の中には持ち込まない"
        },
        {
            ...
            options: [
                ...
                "地域住民の迷惑になるため、たとえ短時間でも車を停めてはいけない"
            ],
            answer: "地域住民の迷惑になるため、たとえ短時間でも車を停めてはいけない"
        }
    ];
